            ...
            for (int j = 0; j < downloads.size() - i - 1; j++) {
                if (type.equals("name")) {
                    if (ascending == true)
                        ...
                        else if (downloads.get(j).getName().compareTo(downloads.get(j + 1).getName()) > 0)
                            Collections.swap(downloads, j, j + 1);
                    ...
                    if (ascending = true)
                        if (downloads.get(j).getVolume() < downloads.get(j + 1).getVolume())
                            Collections.swap(downloads, j, j + 1);
                        else if (downloads.get(j).getVolume() > downloads.get(j + 1).getVolume())
                            Collections.swap(downloads, j, j + 1);
                    ...
                    if (ascending = true)
                        if (downloads.get(j).getAddTime().compareTo(downloads.get(j + 1).getAddTime()) < 0)
                            Collections.swap(downloads, j, j + 1);
                        else if (downloads.get(j).getAddTime().compareTo(downloads.get(j + 1).getAddTime()) > 0)
                            Collections.swap(downloads, j, j + 1);
                }
            }
    }
